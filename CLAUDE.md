...
- **Tokens** : `color/background/projects/*`, `color/text/nav-bar/*` (sous-titre), primitifs `-50` par famille de couleur pour le titre (pas de token semantic dédié — voir COMPONENTS.md)
